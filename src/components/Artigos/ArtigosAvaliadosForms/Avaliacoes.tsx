...
const Formulario: React.FC = () => {
    ...
    return (
        <form className="ml-16 bg-white w-[80%] p-8 rounded-xl shadow-lg">
            <div className="grid grid-cols-2 gap-8">
                <div className="col-span-1 grid grid-cols-1 gap-4 w-[210%]">
                    <div className=''>
                    <div className='w-full flex justify-end'>
                        <span className='p-1 px-2 rounded-xl border-2 border-[#4B00E0] cursor-pointer'>
                            <img src='/assets/Artigos/eye-show.png' className=''/>
                        </span>
                    </div>
                        <label htmlFor="texto1" className="block mb-2 font-medium">Avaliador:</label>
                        <select name="cars" id="cars" className='border-2 border-gray-100 p-2 rounded-xl w-full mb-4'>
                            <option value="volvo">Isabela Silva</option>
