            ...
            <div className="grid grid-cols-2 gap-12">
                ...
                <div className="col-span-1 grid grid-cols-1 gap-4">
                    <div className='mb-2'>
                        ...
                        <input type="text" id="input1" name="input1" className="bg-[#E9E9E9] text-black w-full h-14 px-4 py-1 text-[16px] border border-[#828282] rounded-xl overflow-y-hidden" placeholder="Input 1" defaultValue={initialValues.input1} />
                    </div>
                    <div className='-mt-14'>
                        <label htmlFor="input2" className="block mb-2 font-normal">Autores:</label>
                        <input type="text" id="input2" name="input2" className="bg-[#E9E9E9] text-black w-full h-10 px-4 py-2 text-[16px] border border-[#828282] rounded-xl overflow-y-hidden" placeholder="Input 2" defaultValue={initialValues.input2} />
                    </div>
                    <div className='-mt-[40px]'>
                        <label htmlFor="input2" className="block mb-2 font-normal">Autores:</label>
                        <input type="text" id="input2" name="input2" className="bg-[#E9E9E9] text-black w-full h-10 px-4 py-2 text-[16px] border border-[#828282] rounded-xl overflow-y-hidden" placeholder="Input 2" defaultValue={initialValues.input3} />
                    </div>
                    <div className='-mt-[30px]'>
                        <label htmlFor="input1" className="block mb-2 font-normal">Título:</label>
                        <input type="text" id="input1" name="input1" className="bg-[#E9E9E9] text-black w-full h-14 px-4 py-1 text-[16px] border border-[#828282] rounded-xl overflow-y-hidden" placeholder="Input 1" defaultValue={initialValues.input4} />
                    </div>
                    <div className='-mt-[10px]'>
                        <label htmlFor="input1" className="block mb-2 font-normal">Título:</label>
                        <input type="text" id="input1" name="input1" className="bg-[#E9E9E9] text-black w-full h-14 px-4 py-1 text-[16px] border border-[#828282] rounded-xl overflow-y-hidden" placeholder="Input 1" defaultValue={initialValues.input5} />
                    </div>
                    <div className='-mt-[5px]'>
                        <label htmlFor="input2" className="block mb-2 font-normal">Autores:</label>
                        <input type="text" id="input2" name="input2" className="bg-[#E9E9E9] text-black w-full h-10 px-4 py-2 text-[16px] border border-[#828282] rounded-xl overflow-y-hidden" placeholder="Input 2" defaultValue={initialValues.input6} />
                    </div>

                    <div className='-mt-[30px] grid grid-cols-2 gap-8'>
                        <div>
                            <label htmlFor="input2" className="block mb-2 font-normal">Autores:</label>
                            <input type="date" id="input2" name="input2" className="bg-[#E9E9E9] text-black w-full h-10 px-4 py-2 text-[16px] border border-[#828282] rounded-xl overflow-y-hidden" placeholder="Input 2" defaultValue={initialValues.input7} />
                        </div>

                        <div>
                            <label htmlFor="input2" className="block mb-2 font-normal">Autores:</label>
                            <input type="date" id="input2" name="input2" className="bg-[#E9E9E9] text-black w-full h-10 px-4 py-2 text-[16px] border border-[#828282] rounded-xl overflow-y-hidden" placeholder="Input 2" defaultValue={initialValues.input8} />
                        </div>
                    </div>
...
<div>
                    <button className="flex flex-row w-full justify-between bg-[#0391C9] hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-xl inline-flex items-center">
                        <span className='ml-[220px] text-white justify-self-center'>Baixar Artigo</span>
