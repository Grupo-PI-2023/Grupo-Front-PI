...
export default function Arquivos({ handleNextClick }: CriarEventoProps) {
	...
	const handleFileApresentChange = (
			...
			try {
				...
				arquivosConfig.forEach(async (config) => {
					const arquivoConfigObj: ArquivoConfig = {
						...
						limiteAvaliadoresPorArquivo:
							config.limiteAvaliadoresPorArquivo,
	...
	return (
		<div className="container-submenu">
			<AlertCard
				message="Arquivos cadastradas com sucesso"
				show={showCard}
			/>
								...
								<div className="mb-5 flex flex-col">
									...
									<div className="w-10/12 rounded-md border border-gray-300 bg-white px-4 py-2">
										<input
											...
											value={limiteAutores}
											onChange={(e) =>
												setLimiteAutores(e.target.value)
											}
											required
										/>
									</div>
								...
								{files.map((arquivo, index) => {
									return (
										...
										>
											...
											<td className="">
												{arquivo.needAvaliation
													? 'Sim'
													: 'Não'}
											</td>
											<td className="">
												{arquivo.needApresentation
													? 'Sim'
													: 'Não'}
											</td>
											<td className="">
