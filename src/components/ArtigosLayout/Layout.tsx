...
import InputCheckbox from '@/components/ArtigosCheckboxs/InputCheckbox';
...
import Pagination from '@/components/ArtigosPagination/pagination';
...
export default function Support() {
	...
	return (
		<div className='relative h-[200vh] flex flex-col justify-center items-center mt-32 container mx-auto'>
