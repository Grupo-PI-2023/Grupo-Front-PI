export type ArticleToRateType = {
	...
	evaluators1: string;
	evaluators2: string;
	areaEvaluators1: string;
	areaEvaluators2: string;
	status: string;
	media: number;
};

export const articlesToRate: ArticleToRateType[] = [
	{
		id: 0,
		resumo:
		...
		evaluators1: 'Gabriel Oliveira',
		evaluators2: 'Isabela Silva',
		areaEvaluators1: 'Tecnologia',
		areaEvaluators2: 'Análise e desenvolvimento de sistemas',
		status: 'Aprovado',
		media: 2
	},
	{
