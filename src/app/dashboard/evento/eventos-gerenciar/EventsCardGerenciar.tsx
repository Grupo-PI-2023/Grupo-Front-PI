...
import { FaCheck } from 'react-icons/fa'; // Importando o ícone de verificado
				...
				>
					<div className="mt-6 grid h-[50%] w-[100%] grid-cols-7">
						...
						<div className="flex flex-col gap-4">
							<div className="items-center mr-5 flex flex-row gap-2 rounded-lg ring-2 ring-black">
							...
							<div className="mr-5 flex flex-row items-center justify-center gap-2 rounded-xl text-nowrap py-1 ring-2 ring-[#4B00E0] bg-[#4B00E0]">
								<button className="ml-2 text-[12px] font-medium text-white">
									Ver avaliações{' '}
								</button>
								<FaCheck className="mr-2 text-white" width={100} />
							</div>
						</div>
					</div>
