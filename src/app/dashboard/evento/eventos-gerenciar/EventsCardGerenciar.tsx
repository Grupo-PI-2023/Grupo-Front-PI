				...
				>
					<div className="mt-6 grid h-[50%] w-[100%] grid-cols-7">
						...
						<div className="flex flex-col gap-4">
							<div className="mr-5 flex flex-row items-center gap-2 rounded-lg ring-2 ring-black">
							...
							<div className="mr-5 flex flex-row items-center justify-center gap-2 text-nowrap rounded-xl bg-[#4B00E0] py-1 ring-2 ring-[#4B00E0]">
