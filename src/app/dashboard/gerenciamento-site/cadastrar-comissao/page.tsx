			...
			<div className="container mb-6 mt-44 flex flex-col items-center">
				...
				<div className="mt-4 flex w-3/4 justify-between">
					<div className="flex items-center justify-center gap-3 rounded-lg border-none p-3 shadow-xl">
						...
						<div>
							{accepted ? (
								<button className="flex items-center gap-2 rounded-xl border-0 border-none p-2 text-white"
									style={{ backgroundColor: '#DD4467' }}>
									<CiCircleCheck className="text-[2rem]" />
									<p>Aceitos</p>
								</button>
							) : (
								<button
									...
									style={{ backgroundColor: '#DD4467' }}
								>
									<CiCircleCheck className="text-[2rem] text-white" />
								...
								if (user.situation === 'accept' && accepted) {
									return (
										...
										>
											...
											<td>{user.email}</td>
											<td className="px-4 py-8 text-center items-center flex flex-row justify-center">

												<button
													className="flex items-center pl-2 justify-center rounded-full border px-2 py-[2px] text-base font-medium border-black bg-transparent text-black "
												>
													Ver Mais
													<IoEyeOutline className="ml-4 text-xl text-black" />
												</button>
											</td>
										</tr>
									);
