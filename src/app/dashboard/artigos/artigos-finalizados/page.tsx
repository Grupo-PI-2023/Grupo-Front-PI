					...
					<form className="w-[60%] rounded-xl bg-white p-8 shadow-lg">
						<div className="grid grid-cols-2 gap-8">
							<div className="col-span-1 grid grid-cols-1 gap-4">
								<div>
									<label htmlFor="texto1" className="mb-2 block font-medium">
										Resumo:
									</label>
									<textarea
										id="texto1"
								...
								<div>
									<label htmlFor="texto2" className="mb-2 block font-normal">
										Abstract:
									</label>
									<textarea
										id="texto2"
								...
								<div>
									<label htmlFor="texto3" className="mb-2 block font-normal">
								...
								<div>
									<label htmlFor="texto4" className="mb-2 block font-normal">
								...
								>
									<span></span>
									<span className="font-normal text-white">Baixar Artigo</span>
									<img
							...
							<div className="col-span-1 grid grid-cols-1 gap-4">
								<div className="mb-8">
									<label htmlFor="input1" className="mb-2 block font-normal">
										Título:
									</label>
									<input
										type="text"
								...
								<div>
									<label htmlFor="input2" className="mb-2 block font-normal">
										Autores:
									</label>
									<input
										type="text"
								...
								<div className="mb-8">
									<label htmlFor="input3" className="mb-2 block font-normal">
										Apresentador:
									</label>
									<input
										type="text"
								...
								<div className="mb-8">
									<label htmlFor="input4" className="mb-2 block font-normal">
										Palavras-Chaves:
									</label>
									<input
										type="text"
