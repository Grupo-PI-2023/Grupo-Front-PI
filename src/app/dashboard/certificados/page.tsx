...
import FilterSearchLine from '@/components/filter-line';
			...
			<div className="container flex-col items-center">
				...
				<div className="w-9/12">
					...
					{EventCertificate.map((event, i) => (
						<div key={i} className="flex items-center rounded-md border border-[#FA023E] p-4 mb-6" style={{boxShadow: "rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.05) 0px 4px 6px -2px"}}>
							<div>
								<Image src={certificate} height={140} alt=""/>
							</div>

							<div className='flex  items-center ml-[4rem] w-full justify-between '>
							<div>
