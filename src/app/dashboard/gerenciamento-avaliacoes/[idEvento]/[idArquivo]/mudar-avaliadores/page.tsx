...
"
					...
					<div className="mb-14 w-[75%]">
						<form className=" rounded-xl bg-white p-8 shadow-lg">
							...
							<div className="flex w-full flex-row items-center justify-center">
								<div className="mt-24 flex w-3/6 flex-row items-center justify-center gap-5">
									<DefaultButton
										label="Baixar Artigo"
					...
					<div className="grid w-[100%] grid-cols-3 gap-4">
						{['jonathan', 'joão', 'Estefanie'].map((index) => (
							<div key={index} className="rounded-xl bg-white p-6 shadow-lg">
								<div className="mb-4">
									...
									<select
										id="avaliador3"
										className="w-full rounded-xl border border-gray-300 p-2 px-4 py-2 text-[18px]"
									>
								...
								<div>
									<label
										htmlFor={`area-${index}`}
										className="mb-2 mt-12 block font-normal"
									>
										Área:
									</label>
									<input
										...
										id={`area-${index}`}
										name={`area-${index}`}
										className="w-full rounded-xl border border-gray-400 bg-gray-400 px-4 py-2 text-[18px] text-black"
